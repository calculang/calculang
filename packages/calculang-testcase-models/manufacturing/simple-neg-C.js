...
/* harmony import */ var _simple_neg_C_cul_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(32);
 // 'neg' logic is the most delicate of all the logic in calculang
// I had more testcases in development, and need to add more

const sales_by_product_ = ({ product_in }) => Object(_simple_neg_C_cul_js__WEBPACK_IMPORTED_MODULE_0__["product"])({ product_in }) == 1 ? 100 : 50;
const product_ = ({ product_in }) => product_in;
const sales_total_ = ({}) =>
[0, 1].reduce((acc, product_in) => Object(_simple_neg_C_cul_js__WEBPACK_IMPORTED_MODULE_0__["sales_by_product"])({ product_in })); // product_in is defined in each call, so that sales_total IS independent of product_in
...
/* harmony import */ var _simple_neg_C_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(30);
...
const sales_by_product$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_neg_C_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* sales_by_product_ */ "b"], JSON.stringify);
const sales_by_product = (a) => {
  return sales_by_product$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_neg_C_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* sales_by_product_ */ "b"])({ product_in }); // never run, but here to "trick" calculang graph logic
};
...
const product$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_neg_C_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* product_ */ "a"], JSON.stringify);
const product = (a) => {
  return product$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_neg_C_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* product_ */ "a"])({ product_in }); // never run, but here to "trick" calculang graph logic
};
...
const sales_total$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_simple_neg_C_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* sales_total_ */ "c"], JSON.stringify);
const sales_total = (a) => {
  return sales_total$m(a);
  // eslint-disable-next-line no-undef
  Object(_simple_neg_C_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* sales_total_ */ "c"])({}); // never run, but here to "trick" calculang graph logic
};
...
//# sourceMappingURL=simple-neg-C.js.map