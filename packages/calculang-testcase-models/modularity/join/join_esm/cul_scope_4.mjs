...
import { table_ as table$, item_row_ as item_row$, sales_price_ as sales_price$ } from "./cul_scope_6.mjs"; // there is already-culed stuff in here, why? imports to memo loader include cul_scope_id, what logic should it apply RE passing forward? eliminate? Probably!
