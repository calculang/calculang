...
import { revenue } from './price-change-reconciliation.cul.js';
...
import {
  ...
  units_ as units_1_,
  price_ as price_1_,
} from './base.cul?cul_scope_id=2&cul_parent_scope_id=1';
export { revenue_, units_1_, price_1_ }; //export { revenue, units_, price_ };
...
export const price_ = ({ price_in, price_multiplier_in }) =>
  price_1({
    price_in,
  }) *
  price_multiplier({
...
export const price_multiplier_ = ({ price_multiplier_in }) =>
  price_multiplier_in;
