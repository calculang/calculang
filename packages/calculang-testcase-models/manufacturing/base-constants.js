...
/* harmony import */ var _base_constants_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(19);
...
const revenue$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_base_constants_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* revenue_ */ "d"], JSON.stringify);
const revenue = (a) => {
  return revenue$m(a);
  // eslint-disable-next-line no-undef
  Object(_base_constants_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* revenue_ */ "d"])({ price_in }); // never run, but here to "trick" calculang graph logic
};
...
const costs$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_base_constants_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* costs_ */ "a"], JSON.stringify);
const costs = (a) => {
  return costs$m(a);
  // eslint-disable-next-line no-undef
  Object(_base_constants_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* costs_ */ "a"])({}); // never run, but here to "trick" calculang graph logic
};
...
const profit$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_base_constants_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* profit_ */ "c"], JSON.stringify);
const profit = (a) => {
  return profit$m(a);
  // eslint-disable-next-line no-undef
  Object(_base_constants_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* profit_ */ "c"])({ price_in }); // never run, but here to "trick" calculang graph logic
};
...
const units$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_base_constants_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* units_ */ "e"], JSON.stringify);
const units = (a) => {
  return units$m(a);
  // eslint-disable-next-line no-undef
  Object(_base_constants_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* units_ */ "e"])({}); // never run, but here to "trick" calculang graph logic
};
...
const price$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_base_constants_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* price_ */ "b"], JSON.stringify);
const price = (a) => {
  return price$m(a);
  // eslint-disable-next-line no-undef
  Object(_base_constants_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* price_ */ "b"])({ price_in }); // never run, but here to "trick" calculang graph logic
};
...
/* harmony import */ var _base_constants_cul_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(18);
const revenue_ = ({ price_in }) => {
  return Object(_base_constants_cul_js__WEBPACK_IMPORTED_MODULE_0__["units"])({}) * Object(_base_constants_cul_js__WEBPACK_IMPORTED_MODULE_0__["price"])({ price_in });
};

// variable costs only, OK for testing
const costs_ = ({}) => 100 * Object(_base_constants_cul_js__WEBPACK_IMPORTED_MODULE_0__["units"])({});

const profit_ = ({ price_in }) => Object(_base_constants_cul_js__WEBPACK_IMPORTED_MODULE_0__["revenue"])({ price_in }) - Object(_base_constants_cul_js__WEBPACK_IMPORTED_MODULE_0__["costs"])({});

// inputs
const units_ = ({}) => 100; // test a constant
