...
const fs = await pre_fetch({source: `
                    ...
                    import { fund_value, age, age_0, empee_contribution_tax_relief } from "https://glcdn.githack.com/declann/calculang.dev/-/raw/main/models/taxes-pensions/pension-calculator.cul.js" //"https://calculang.dev/models/taxes-pensions/pension-calculator.cul.js"; // BUG TOFIX TODO I can't do ?v=x etc.
