...
/* harmony import */ var _revenue_fixed_inputs_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(33);
...
const revenue$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_revenue_fixed_inputs_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* revenue_ */ "b"], JSON.stringify);
const revenue = (a) => {
  return revenue$m(a);
  // eslint-disable-next-line no-undef
  Object(_revenue_fixed_inputs_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* revenue_ */ "b"])({}); // never run, but here to "trick" calculang graph logic
};
...
const units$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_revenue_fixed_inputs_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* units_ */ "c"], JSON.stringify);
const units = (a) => {
  return units$m(a);
  // eslint-disable-next-line no-undef
  Object(_revenue_fixed_inputs_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* units_ */ "c"])({}); // never run, but here to "trick" calculang graph logic
};
...
const price$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_revenue_fixed_inputs_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* price_ */ "a"], JSON.stringify);
const price = (a) => {
  return price$m(a);
  // eslint-disable-next-line no-undef
  Object(_revenue_fixed_inputs_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* price_ */ "a"])({}); // never run, but here to "trick" calculang graph logic
};
...
/* harmony import */ var _base_cul_cul_scope_id_2_cul_parent_scope_id_1__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(49);
/* harmony import */ var _revenue_fixed_inputs_cul_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
const revenue_ = ({}) => {
  return Object(_revenue_fixed_inputs_cul_js__WEBPACK_IMPORTED_MODULE_1__["units"])({}) * Object(_revenue_fixed_inputs_cul_js__WEBPACK_IMPORTED_MODULE_1__["price"])({});
};

// variable costs only, OK for testing
const costs_ = ({}) => 100 * Object(_revenue_fixed_inputs_cul_js__WEBPACK_IMPORTED_MODULE_1__["units"])({});

const profit_ = ({}) => Object(_revenue_fixed_inputs_cul_js__WEBPACK_IMPORTED_MODULE_1__["revenue"])({}) - Object(_base_cul_cul_scope_id_2_cul_parent_scope_id_1__WEBPACK_IMPORTED_MODULE_0__[/* costs */ "a"])({});
...
/* harmony import */ var _revenue_fixed_inputs_cul_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(11);
/* harmony import */ var _base_cul_cul_scope_id_2_cul_parent_scope_id_1__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(49);
...
const revenue_ = (a) => {
  return revenue$m(a);
  // eslint-disable-next-line no-undef
  Object(_base_cul_js_memoed_cul_scope_id_3_cul_parent_scope_id_2__WEBPACK_IMPORTED_MODULE_2__[/* revenue_ */ "d"])({}); // never run, but here to "trick" calculang graph logic
};
////////// end revenue memo-loader code //////////
...
const costs = (a) => {
  return costs$m(a);
  // eslint-disable-next-line no-undef
  Object(_base_cul_js_memoed_cul_scope_id_3_cul_parent_scope_id_2__WEBPACK_IMPORTED_MODULE_2__[/* costs_ */ "a"])({}); // never run, but here to "trick" calculang graph logic
};
...
const profit = (a) => {
  return profit$m(a);
  // eslint-disable-next-line no-undef
  Object(_base_cul_js_memoed_cul_scope_id_3_cul_parent_scope_id_2__WEBPACK_IMPORTED_MODULE_2__[/* profit_ */ "c"])({}); // never run, but here to "trick" calculang graph logic
};
...
//# sourceMappingURL=revenue-fixed-inputs.js.map