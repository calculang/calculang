...
/* harmony import */ var _price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
...
const revenue$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* revenue_ */ "d"], JSON.stringify);
const revenue = (a) => {
  return revenue$m(a);
  // eslint-disable-next-line no-undef
  Object(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* revenue_ */ "d"])({ step_in, units_in, price_in, price_multiplier_in }); // never run, but here to "trick" calculang graph logic
};
...
const units_1$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* units_1_ */ "g"], JSON.stringify);
const units_1 = (a) => {
  return units_1$m(a);
  // eslint-disable-next-line no-undef
  Object(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* units_1_ */ "g"])({ units_in }); // never run, but here to "trick" calculang graph logic
};
...
const price_1$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* price_1_ */ "b"], JSON.stringify);
const price_1 = (a) => {
  return price_1$m(a);
  // eslint-disable-next-line no-undef
  Object(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* price_1_ */ "b"])({ price_in }); // never run, but here to "trick" calculang graph logic
};
...
const units$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* units_ */ "f"], JSON.stringify);
const units = (a) => {
  return units$m(a);
  // eslint-disable-next-line no-undef
  Object(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* units_ */ "f"])({ step_in, units_in, price_in, price_multiplier_in }); // never run, but here to "trick" calculang graph logic
};
...
const price$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* price_ */ "a"], JSON.stringify);
const price = (a) => {
  return price$m(a);
  // eslint-disable-next-line no-undef
  Object(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* price_ */ "a"])({ price_in, price_multiplier_in }); // never run, but here to "trick" calculang graph logic
};
...
const price_multiplier$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* price_multiplier_ */ "c"], JSON.stringify);
const price_multiplier = (a) => {
  return price_multiplier$m(a);
  // eslint-disable-next-line no-undef
  Object(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* price_multiplier_ */ "c"])({ price_multiplier_in }); // never run, but here to "trick" calculang graph logic
};
...
const step$m = Object(underscore__WEBPACK_IMPORTED_MODULE_0__[/* memoize */ "a"])(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* step_ */ "e"], JSON.stringify);
const step = (a) => {
  return step$m(a);
  // eslint-disable-next-line no-undef
  Object(_price_change_reconciliation_nomemo_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_1__[/* step_ */ "e"])({ step_in }); // never run, but here to "trick" calculang graph logic
};
...
/* harmony import */ var _price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
...
Object(_price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_0__["step"])({ step_in }) >= 1 ? Object(_price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_0__["units_1"])({ units_in }) + (Object(_price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_0__["price"])({ price_in, price_multiplier_in }) - Object(_price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_0__["price_1"])({ price_in })) * -0.005 : Object(_price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_0__["units_1"])({ units_in });
const price_ = ({ price_in, price_multiplier_in }) => Object(_price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_0__["price_1"])({ price_in }) * Object(_price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_0__["price_multiplier"])({ price_multiplier_in });
...
/* harmony import */ var _price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(3);
const revenue_ = ({ step_in, units_in, price_in, price_multiplier_in }) => {
  return Object(_price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_1__["units"])({ step_in, units_in, price_in, price_multiplier_in }) * Object(_price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_1__["price"])({ price_in, price_multiplier_in });
};

// variable costs only, OK for testing
const costs_ = ({ step_in, units_in, price_in, price_multiplier_in }) => 100 * Object(_price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_1__["units"])({ step_in, units_in, price_in, price_multiplier_in });

const profit_ = ({ step_in, units_in, price_in, price_multiplier_in }) => Object(_price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_1__["revenue"])({ step_in, units_in, price_in, price_multiplier_in }) - Object(_base_cul_cul_scope_id_2_cul_parent_scope_id_1__WEBPACK_IMPORTED_MODULE_0__[/* costs */ "a"])({ step_in, units_in, price_in, price_multiplier_in });
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return price_; });
/* harmony import */ var _price_change_reconciliation_nomemo_cul_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(3);
/* harmony import */ var underscore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(16);
/* harmony import */ var _base_cul_js_memoed_cul_scope_id_3_cul_parent_scope_id_2__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(21);
...
const revenue_ = (a) => {
  return revenue$m(a);
  // eslint-disable-next-line no-undef
  Object(_base_cul_js_memoed_cul_scope_id_3_cul_parent_scope_id_2__WEBPACK_IMPORTED_MODULE_2__[/* revenue_ */ "d"])({ step_in, units_in, price_in, price_multiplier_in }); // never run, but here to "trick" calculang graph logic
};
////////// end revenue memo-loader code //////////
...
const profit = (a) => {
  return profit$m(a);
  // eslint-disable-next-line no-undef
  Object(_base_cul_js_memoed_cul_scope_id_3_cul_parent_scope_id_2__WEBPACK_IMPORTED_MODULE_2__[/* profit_ */ "c"])({ step_in, units_in, price_in, price_multiplier_in }); // never run, but here to "trick" calculang graph logic
};
...
//# sourceMappingURL=price-change-reconciliation-nomemo.js.map