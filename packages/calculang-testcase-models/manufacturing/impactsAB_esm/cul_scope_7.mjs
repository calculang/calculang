...
import { revenue_, profit_, units_ as units_1_, price_ as price_1_ } from "./cul_scope_8.mjs"; // don't pollute the _ modifier
export { revenue_, profit_, units_1_, price_1_ };
