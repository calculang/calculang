    ...
    import { revenue_ as revenue$, profit_ as profit$, costs_ as costs$, units_ as units$, price_ as price$ } from './revenue-fixed-inputs.cul.js?&+memoed'; // there is already-culed stuff in here, why? imports to memo loader include cul_scope_id, what logic should it apply RE passing forward? eliminate? Probably!
