...
export const B_units = (a) => {
  return B_units$m(a);
  // eslint-disable-next-line no-undef
  B_units$({ step_in, units_in, price_in, price_multiplier_in }); // never run, but here to "trick" calculang graph logic
};
...
export const B_price = (a) => {
  return B_price$m(a);
  // eslint-disable-next-line no-undef
  B_price$({ price_in, price_multiplier_in }); // never run, but here to "trick" calculang graph logic
};
...
export const units_impact = (a) => {
  ...
  // eslint-disable-next-line no-undef
  units_impact$({ step_in, units_in, price_in, price_multiplier_in }); // never run, but here to "trick" calculang graph logic
};
...
export const price_impact = (a) => {
  ...
  // eslint-disable-next-line no-undef
  price_impact$({ price_in, price_multiplier_in }); // never run, but here to "trick" calculang graph logic
};
