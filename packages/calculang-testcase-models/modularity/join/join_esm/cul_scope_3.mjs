...
import { table_ as table$, customer_row_ as customer_row$, name_ as name$, rating_ as rating$ } from "./cul_scope_7.mjs"; // there is already-culed stuff in here, why? imports to memo loader include cul_scope_id, what logic should it apply RE passing forward? eliminate? Probably!
