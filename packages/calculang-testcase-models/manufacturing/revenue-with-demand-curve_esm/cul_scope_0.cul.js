    ...
    import { revenue_ as revenue$, price_ as price$, profit_ as profit$, units_ as units$ } from './revenue-with-demand-curve.cul.js?+memoed'; // there is already-culed stuff in here, why? imports to memo loader include cul_scope_id, what logic should it apply RE passing forward? eliminate? Probably!
