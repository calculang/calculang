...
import { table_ as table$, order_ as order$, order_row_ as order_row$, customer_ as customer$, item_ as item$ } from "./cul_scope_5.mjs"; // there is already-culed stuff in here, why? imports to memo loader include cul_scope_id, what logic should it apply RE passing forward? eliminate? Probably!
...
export const order_row = (a) => {
  ...
  // eslint-disable-next-line no-undef
  order_row$({ order_in }); // never run, but here to "trick" calculang graph logic
};
