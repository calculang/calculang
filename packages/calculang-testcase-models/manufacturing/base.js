...
/* harmony import */ var lru_memoize__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(43);
/* harmony import */ var underscore__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(44);
/* harmony import */ var _base_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(19);

 // TODO poor tree shaking support, or why is this impact so massive? Move to lodash/lodash-es?

 ////////// start revenue memo-loader code //////////

const revenue$m = Object(lru_memoize__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(999999, underscore__WEBPACK_IMPORTED_MODULE_1__[/* isEqual */ "a"])(_base_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_2__[/* revenue_ */ "d"]);
const revenue = a => {
  return revenue$m(a);
  Object(_base_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_2__[/* revenue_ */ "d"])({
    units_in,
    price_in
...
const costs$m = Object(lru_memoize__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(999999, underscore__WEBPACK_IMPORTED_MODULE_1__[/* isEqual */ "a"])(_base_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_2__[/* costs_ */ "a"]);
const costs = a => {
  return costs$m(a);
  Object(_base_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_2__[/* costs_ */ "a"])({
    units_in
  }); // never run, but here to "trick" calculang graph logic
}; ////////// end costs memo-loader code //////////
////////// start profit memo-loader code //////////

const profit$m = Object(lru_memoize__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(999999, underscore__WEBPACK_IMPORTED_MODULE_1__[/* isEqual */ "a"])(_base_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_2__[/* profit_ */ "c"]);
const profit = a => {
  return profit$m(a);
  Object(_base_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_2__[/* profit_ */ "c"])({
    units_in,
    price_in
  }); // never run, but here to "trick" calculang graph logic
...
const units$m = Object(lru_memoize__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(999999, underscore__WEBPACK_IMPORTED_MODULE_1__[/* isEqual */ "a"])(_base_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_2__[/* units_ */ "e"]);
const units = a => {
  return units$m(a);
  Object(_base_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_2__[/* units_ */ "e"])({
    units_in
  }); // never run, but here to "trick" calculang graph logic
}; ////////// end units memo-loader code //////////
////////// start price memo-loader code //////////

const price$m = Object(lru_memoize__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"])(999999, underscore__WEBPACK_IMPORTED_MODULE_1__[/* isEqual */ "a"])(_base_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_2__[/* price_ */ "b"]);
const price = a => {
  return price$m(a);
  Object(_base_cul_js_memoed_cul_scope_id_1_cul_parent_scope_id_0__WEBPACK_IMPORTED_MODULE_2__[/* price_ */ "b"])({
    price_in
  }); // never run, but here to "trick" calculang graph logic
...
const revenue_ = ({
  ...
  return Object(_base_cul_js__WEBPACK_IMPORTED_MODULE_0__["units"])({
    units_in
  }) * Object(_base_cul_js__WEBPACK_IMPORTED_MODULE_0__["price"])({
    price_in
  });
...
const costs_ = ({
  units_in
}) => 100 * Object(_base_cul_js__WEBPACK_IMPORTED_MODULE_0__["units"])({
  units_in
});
const profit_ = ({
  units_in,
  price_in
}) => Object(_base_cul_js__WEBPACK_IMPORTED_MODULE_0__["revenue"])({
  units_in,
  price_in
}) - Object(_base_cul_js__WEBPACK_IMPORTED_MODULE_0__["costs"])({
  units_in
}); // inputs
