    ...
    import { sales_by_product_ as sales_by_product$, product_ as product$, sales_total_ as sales_total$ } from './simple-neg-C.cul.js?+memoed'; // there is already-culed stuff in here, why? imports to memo loader include cul_scope_id, what logic should it apply RE passing forward? eliminate? Probably!
